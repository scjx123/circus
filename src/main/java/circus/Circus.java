...
//        System.out.println(animals.length);
        ...
        ArrayList <Animal> animalArrayList = new ArrayList<>(Arrays.asList(animals)); //adding the existing animal arraylist
        ...
        System.out.println("Index of Louis: "+ animalArrayList.indexOf(louie));
